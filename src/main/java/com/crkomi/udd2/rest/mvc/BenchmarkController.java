...
import com.crkomi.udd2.tools.util.QueryAndRelevantDocumentsList;
...
@Controller
@RequestMapping("/LuceneAnalyzerTester/rest/benchmark")
public class BenchmarkController {
    ...
    public ResponseEntity<String> createBenchmark(@RequestBody BenchmarkModel benchmarkModel) throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
		...
		com.crkomi.udd2.entities.Analyzer selectedAnalyzer = analyzerService.findAnalyzer(benchmarkModel.getAnalyzerType());
	    ...
	    String realPathAllDocs = servletContext.getRealPath(File.separator + "docs") + File.separator + user.getUsername() + File.separator + benchmarkModel.getDirectoryName();
    ...
    public ResponseEntity<BenchmarkList> getAllBenchmarksForThisUser() {
		...
		while(it.hasNext()) {
			...
			com.crkomi.udd2.tools.models.SearchModel sm = new com.crkomi.udd2.tools.models.SearchModel();
