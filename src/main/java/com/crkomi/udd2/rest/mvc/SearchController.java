...
import com.crkomi.udd2.tools.models.RequiredHighlight;
import com.crkomi.udd2.tools.models.SearchModel;
import com.crkomi.udd2.tools.models.SearchResultModel;
...
@Controller
@RequestMapping("/LuceneAnalyzerTester/rest/search")
public class SearchController {
    ...
    public ResponseEntity<SearchResultModel> search(@RequestBody SearchModel searchModel) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		com.crkomi.udd2.entities.Analyzer selectedAnalyzer = analyzerService.findAnalyzer(searchModel.getAnalyzerId());
