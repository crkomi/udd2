...
@Controller
@RequestMapping("/LuceneAnalyzerTester/rest/accounts")
public class AccountController {
    ...
    public ResponseEntity<Account> createAccount(
	   ...
	   sentAccount.setDirectoryPath(realPathDocs + File.separator + dirName);
    ...
    public ResponseEntity<Account> createAccountByAdmin(
        ...
        String fileName = sentAccount.getUsername();
 	    File newDirectory = new File(realPathDocs + File.separator + fileName);
 	    newDirectory.mkdirs();
